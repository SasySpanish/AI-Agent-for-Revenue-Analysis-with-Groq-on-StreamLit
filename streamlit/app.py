...
# ---------------------------------------------------------------------------
# PATH — wheelhouse core + agente groq
# ---------------------------------------------------------------------------

WHEELHOUSE_PATH   = r"C:/Users/Utente/Desktop/revenuescript"
GROQ_AGENT_PATH   = r"C:/Users/Utente/Desktop/GroqRevAgent"

for p in [WHEELHOUSE_PATH, GROQ_AGENT_PATH]:
    if p not in sys.path:
        sys.path.insert(0, p)

load_dotenv(os.path.join(GROQ_AGENT_PATH, ".env"))
...
st.set_page_config(
    page_title="Wheelhouse — Financial Analysis",
    page_icon="📊",
    layout="wide",
...
<div class="main-header">
  <h1>📊 Wheelhouse — Financial Analysis Agent</h1>
  <p>Powered by llama-3.3-70b via Groq · Data from Yahoo Finance</p>
</div>
""", unsafe_allow_html=True)
